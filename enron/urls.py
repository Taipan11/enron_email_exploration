...
from .views import collaborator_list, collaborator_detail, folder_detail, message_detail, collaborator_sent_messages, message_thread, dashboard
...
urlpatterns = [
    ...
    path("messages/<int:occurrence_id>/", message_detail, name="message_detail"),
